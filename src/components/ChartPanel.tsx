...
const ChartPanel: React.FC<ChartPanelProps> = ({ hourlyData, topSellingItems }) => {
  return (
    <div className="flex flex-col md:flex-row bg-acai-900 rounded-lg p-4 h-full gap-4">
      ...
      <div className="md:w-1/2 flex flex-col">
        <h3 className="text-base font-bold mb-4 text-center text-white">Mais Vendidos</h3>
